...
name: running-cost
description: |
  `02.design-doc.md`（アーキテクチャ設計）を受け取り、月額ランニングコスト・運用保守コスト・障害対応コスト・年間TCO を算出した `05.running-cost.md` を生成するスキル。
...
- 06.proposal.md を生成する前の前処理として（req-full 内から呼ばれる場合）
...
### Step 7: 05.running-cost.md を出力する
